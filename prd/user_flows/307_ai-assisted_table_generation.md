...
AI-Assisted Table Generation enables users to create data tables and summaries through natural language prompts. This feature leverages Impala's context understanding to automatically generate properly formatted tables with the right dimensions, metrics, and aggregations. Users can request specific data cuts without manually configuring pivot tables or writing queries.
